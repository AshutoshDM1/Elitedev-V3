    ...
    <SubSection>
      <div className="p-2 space-y-5">
        <div className="space-y-4">
          <p className="text-[14px] text-zinc-600 dark:text-zinc-300/80">
...
export function Socials() {
  const socials = [
    {
      name: "GitHub",
      url: "https://github.com/rinkitchavda",
    ...
    {
      name: "Twitter",
      url: "https://twitter.com/rinkitchavda",
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    ...
    {
      name: "Instagram",
      url: "https://instagram.com/rinkitchavda",
      icon: (props: React.SVGProps<SVGSVGElement>) => (
    ...
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/rinkitchavda",
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
  ...
  return (
    <div className="space-y-3">
      <p className="text-[13px] font-normal text-zinc-500 dark:text-zinc-400">
        Here are my <strong className="font-semibold text-zinc-950 dark:text-white">socials</strong>
      </p>
